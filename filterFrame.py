...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        Toplevel.__init__(self,master=master,bg="#b4f5ce")
        ...
        self.negative_button = Button(master=self, text="Negative",fg="black")
        self.black_white_button = Button(master=self, text="Black White",fg="black")
        self.sepia_button = Button(master=self, text="Sepia",fg="black")
        self.emboss_button = Button(master=self, text="Emboss",fg="black")
        self.gaussian_blur_button = Button(master=self, text="Gaussian Blur",fg="black")
        self.median_blur_button = Button(master=self, text="Median Blur",fg="black")
        self.cancel_button = Button(master=self, text="Cancel",fg="black")
        self.apply_button = Button(master=self, text="Apply",fg="black")
